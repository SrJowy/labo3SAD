...
# Model K Nearest Neighbors (k=1) (s1), trained on 2022-03-03 12:30:38.

# #### Generated on 2022-03-03 11:31:04.402769
...
preparation_steps = []
preparation_output_schema = {u'userModified': False, u'columns': [{u'type': u'double', u'name': u'Largo de sepalo'}, {u'type': u'double', u'name': u'Ancho de sepalo'}, {u'type': u'double', u'name': u'Largo de petalo'}, {u'type': u'double', u'name': u'Ancho de petalo'}, {u'type': u'string', u'name': u'Especie'}]}
...
ml_dataset = ml_dataset[[u'Largo de petalo', u'Especie', u'Ancho de petalo', u'Largo de sepalo', u'Ancho de sepalo']]
...
numerical_features = [u'Largo de petalo', u'Ancho de petalo', u'Largo de sepalo', u'Ancho de sepalo']
text_features = []
...
target_map = {u'Iris-virginica': 1, u'Iris-setosa': 2, u'Iris-versicolor': 0}
...
impute_when_missing = [{'impute_with': u'MEAN', 'feature': u'Largo de petalo'}, {'impute_with': u'MEAN', 'feature': u'Ancho de petalo'}, {'impute_with': u'MEAN', 'feature': u'Largo de sepalo'}, {'impute_with': u'MEAN', 'feature': u'Ancho de sepalo'}]
...
rescale_features = {u'Largo de petalo': u'AVGSTD', u'Ancho de sepalo': u'AVGSTD', u'Ancho de petalo': u'AVGSTD', u'Largo de sepalo': u'AVGSTD'}
...
get_ipython().magic(u'time clf.fit(X_train, y_train)')
...
get_ipython().magic(u'time _predictions = clf.predict(X_test)')
get_ipython().magic(u'time _probas = clf.predict_proba(X_test)')
